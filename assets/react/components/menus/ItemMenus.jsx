...
const ItemMenus = ({ menu, index }) => {
    const [img, setImg] = useState(null);

    useEffect(() => {
        setImg(menu.imageName);
    }, []);

    return (
        <article className="menuItem">
            {/* -------------------- menu classique avec photo ----------------  */}
            {img != null ? (
                <div className="menuItem__classique">
                    <div
                        className="menuItem__classique__text"
                        /* ------- change le style 1 fois sur 2---------  */
                        style={
                            index % 2 === 0
                                ? { backgroundColor: '#523c48', order: '1' }
...
-24 -36 -22 0 -26 6 -32 45 -3 25 -4 51 0 60 7 18 33 9 46 -16z"
                        ...
                        <div
                            className="menuItem__classique__text--dish"
                            style={index % 2 === 0 ? { color: '#f0f2ff' } : { color: '#3f0325' }}
                        >
                            {menu.dessert}
                        </div>
                        <svg
...
-24 -36 -22 0 -26 6 -32 45 -3 25 -4 51 0 60 7 18 33 9 46 -16z"
                        ...
                        <div
                            ...
                            style={index % 2 === 0 ? { color: '#f0f2ff' } : { color: '#0e0008' }}
                        >
                            Prix: <span>{menu.price}€</span>
                        </div>
                    </div>

                    <div
                        className="menusItem__classique__image"
                        style={{
                            backgroundImage: `url("../uploads/meals/${img}")`,
                ...
                <div className="menuItem__formula">
                    ...
                    {menu.formulas.map((formula) => (
                        <div key={formula.id} className="menuItem__formula__formul">
                            <div className="menuItem__formula__formul--name">{formula.name}</div>
                            <div className="menuItem__formula__formul--description">
                                {formula.description}
                            </div>
                            <div className="menuItem__formula__formul--price">
                                Prix: <span>{formula.price}€</span>
                            </div>
                        </div>
                    ))}
                </div>
...
{
    /* <img src={`../uploads/meals/${img}`} alt="" style={{ width: '100%' }} /> */
}
