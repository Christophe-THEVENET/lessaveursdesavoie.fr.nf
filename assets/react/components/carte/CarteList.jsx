...
const CarteList = () => {
    ...
    const getEntryList = async () => {
        try {
            const response = await axios.get('http://127.0.0.1:8000/api/dishes/entree');
    ...
    // requête axios pour récupérer les plats
    const [dishList, setDishList] = useState([]);
    const getDishList = async () => {
        try {
            const response = await axios.get('http://127.0.0.1:8000/api/dishes/plat');
    ...
    // requête axios pour récupérer les desserts
    const [dessertList, setDessertList] = useState([]);
    const getDessertList = async () => {
        try {
            const response = await axios.get('http://127.0.0.1:8000/api/dishes/dessert');
...
-24 -36 -22 0 -26 6 -32 45 -3 25 -4 51 0 60 7 18 33 9 46 -16z"
                ...
                <div
                    className="carte__block__image"
                    style={{
                        backgroundImage: `url("${imgEntry}")`,
            ...
            {/* ------------------------------ plats ------------------------- */}
            <article className="dishes carte__block">
                <div
                    className="dishes__image carte__block__image"
                    style={{
                        backgroundImage: `url("${imgDishes}")`,
                        backgroundSize: 'cover',
                        backgroundPosition: 'center',
                        backgroundRepeat: 'no-repeat',
                        width: '100%',
...
-24 -36 -22 0 -26 6 -32 45 -3 25 -4 51 0 60 7 18 33 9 46 -16z"
                ...
                <div
                    className="carte__block__image"
                    style={{
                        backgroundImage: `url("${imgDessert}")`,
                        backgroundSize: 'cover',
                        backgroundPosition: 'center',
                        backgroundRepeat: 'no-repeat',
                        width: '100%',
